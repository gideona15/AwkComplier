...
public class Token {
    ...
    protected enum TokenType {
        ...
        NUMBER, SEPARATOR, WHILE, IF, DO, FOR, BREAK, CONTINUE, ELSE, RETURN, BEGIN, END, PRINT, PRINTF, NEXT, IN,SEMICOLON,
        DELETE,STRINGLITERAL,PLUS, MINUS, GETLINE, EXIT, NEXTFILE, FUNCTION, Pattern, LENGTH, SUBSTR, INDEX, SPLIT, GSUB, SPRINTF, TOLOWER, TOUPPER, SUB
    }
